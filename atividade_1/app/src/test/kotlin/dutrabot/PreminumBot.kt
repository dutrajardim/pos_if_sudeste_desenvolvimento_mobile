...
class PreminumBotTest {
    ...
    fun testPreminumBot() {
        ...
        //  responder "É para já!" e realize a ação do utilizador
        //  A ação do utilizador deverá ser passada como parâmetro do construtor da classe usando
        //  uma ‘interface’ definida na versão de luxo do robô
        check("Fazer café. Agir", "É para já! Fazendo café...")
        check("Subir escadas. Agir", "É para já! Subindo escadas...")
    }
}